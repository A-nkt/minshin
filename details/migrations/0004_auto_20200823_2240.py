...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('details', '0003_detailspage_university_link'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='details.DetailsPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
