...
class AboutPage(Page):
    ...
    content = StreamField([("title", blocks.AboutTitleBlock())], null=True, blank=True)
    # 上記で定義した各フィールドを各Panelとして定義
    content_panels = Page.content_panels + [FieldPanel("banner_title"), FieldPanel("banner_subtitle"), ImageChooserPanel("banner_image"), StreamFieldPanel('content')]
